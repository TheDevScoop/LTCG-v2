...
const toAvatarPath = (id: SignupAvatarId): SignupAvatarPath => `avatars/signup/${id}.png`
...
export function isSignupAvatarPath(value: string | null | undefined): value is SignupAvatarPath {
  if (!value) return false
  return SIGNUP_AVATAR_OPTIONS.some((avatar) => avatar.path === value)
}
